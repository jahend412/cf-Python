...
# Define the main_menu function and create a while loop to keep the menu running until the user chooses to quit
...
# Define the create_recipe function
...
# Define the search_recipe function
...
# Define the update_recipe function
...
# Define the delete_recipe function
...
# Define the view_all_recipes function
